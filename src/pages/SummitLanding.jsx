...
export default function SummitLanding(){
  ...
  return <div className="sx2">
    ...
    <div className="sx2-marquee" aria-label="Summit of American Spaces in Nigeria 2026">
        <div className="sx2-marquee-glow"/>
        <div className="sx2-marquee-track">
          <span>SUMMIT OF AMERICAN SPACES <em>IN NIGERIA</em> <b>2026</b></span><i>✦</i>
          <span>SUMMIT OF AMERICAN SPACES <em>IN NIGERIA</em> <b>2026</b></span><i>✦</i>
          <span>SUMMIT OF AMERICAN SPACES <em>IN NIGERIA</em> <b>2026</b></span><i>✦</i>
          <span>SUMMIT OF AMERICAN SPACES <em>IN NIGERIA</em> <b>2026</b></span><i>✦</i>
        </div>
      ...
      <section className="sx2-hero">
        ...
        <div className="sx2-hero-content"><div className="sx2-overline"><span className="pulse"/><span>SUMMIT OF AMERICAN SPACES IN NIGERIA</span><b>2026</b></div><h1>BUILT<br/><em>ON AMERICAN AI.</em></h1><p>Equipping American Spaces Nigeria to showcase the U.S. AI Stack through people, programming, creativity and practical innovation.</p><div className="sx2-actions"><button className="sx2-main-cta" onClick={()=>navigate('/summit-2026/register')}>JOIN THE SUMMIT <span>→</span></button><button className="sx2-ghost-cta" onClick={()=>navigate('/summit-2026/live')}><span className="play">▶</span> ENTER LIVE SCREEN</button></div></div>
