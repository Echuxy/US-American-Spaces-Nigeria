...
function SummitRoutes(){return <Routes><Route path="/summit-2026/register" element={<SummitRegistration/>}/><Route path="/summit-2026" element={<Summit2026/>}/><Route path="/summit-2026/control-room/login" element={<SummitCoordinatorLogin/>}/><Route path="/summit-2026/coordinator" element={<SummitGate Component={SummitCoordinatorWorkspace}/>}/><Route path="/summit-2026/control-room/content" element={<SummitGate Component={SummitContentManager}/>}/><Route path="/summit-2026/control-room/participants" element={<SummitGate Component={SummitParticipantManager}/>}/><Route path="/summit-2026/control-room" element={<SummitGate Component={SummitControlRoom}/>}/><Route path="/american-spaces-nigeria" element={<Navigate to="/summit-2026" replace/>}/><Route path="*" element={<ExistingApplicationRoutes/>}/></Routes>}
