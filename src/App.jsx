...
function SummitRoutes(){return <Routes><Route path="/summit-2026/register" element={<SummitRegistration/>}/><Route path="/summit-2026" element={<Summit2026/>}/><Route path="/summit-2026/control-room/login" element={<SummitCoordinatorLogin/>}/><Route path="/summit-2026/control-room/content" element={<SummitGate Component={SummitContentManager}/>}/><Route path="/summit-2026/control-room" element={<SummitGate Component={SummitControlRoom}/>}/><Route path="*" element={<ExistingApplicationRoutes/>}/></Routes>}
