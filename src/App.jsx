...
import { AuthProvider, Routes as ExistingRoutes, Route as ExistingRoute } from 'react-router-dom'
...
function useAuth(){return {user:null,loading:false,profile:null}}
...
function SummitRoutes(){return <Routes><Route path="/summit-2026/register" element={<SummitRegistration/>}/><Route path="/summit-2026" element={<Summit2026/>}/><Route path="/summit-2026/control-room/login" element={<SummitCoordinatorLogin/>}/><Route path="/summit-2026/coordinator" element={<SummitGate Component={SummitCoordinatorWorkspace}/>}/><Route path="/summit-2026/control-room/content" element={<SummitGate Component={SummitContentManager}/>}/><Route path="/summit-2026/control-room/participants" element={<SummitGate Component={SummitParticipantManager}/>}/><Route path="/summit-2026/control-room" element={<SummitGate Component={SummitControlRoom}/>}/><Route path="*" element={<ExistingApplicationRoutes/>}/></Routes>}
